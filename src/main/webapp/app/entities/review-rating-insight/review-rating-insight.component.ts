...
@Component({
    selector: 'jhi-review-rating-insight',
    templateUrl: './review-rating-insight.component.html'
})
export class ReviewRatingInsightComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.reviewService
                ...
                .subscribe(
                    (res: HttpResponse<IReviewRatingInsight[]>) => this.paginateReviews(res.body, res.headers),
    ...
    trackId(index: number, item: IReviewRatingInsight) {
        return item.id;
    }
    ...
    private paginateReviews(data: IReviewRatingInsight[], headers: HttpHeaders) {
