package com.insightsystems.ratinginsight.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("RatingSystem");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("RatingSystem");
        ...
        config.getMapConfigs().put("com.insightsystems.ratinginsight.domain.*", initializeDomainMapConfig(jHipsterProperties));
